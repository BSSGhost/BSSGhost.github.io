...
const translations = {
  fr: {
    ...
    lang_switch_to_en: "Passer en anglais",
    lang_switch_to_fr: "Passer en français",
    ...
    prof_password_show: "Afficher le mot de passe",
    prof_password_hide: "Masquer le mot de passe",
    ...
    prof_nav_breadcrumb_label: "Navigation du mode professeur",
    prof_logout_btn: "Se déconnecter",
    prof_reset_data_btn: "Réinitialiser les données",
    prof_confirm_reset_data: "Toutes les classes, les élèves et les notes du mode professeur seront définitivement supprimés. Cette action est irréversible. Continuer ?",
    prof_data_reset_done: "Données du mode professeur réinitialisées !",
    ...
    prof_confirm_delete_class: "Supprimer la classe « {classe} » ? Elle sera déplacée dans la corbeille.",
    prof_confirm_delete_student: "Supprimer cet élève de la classe ? Il sera déplacé dans la corbeille avec ses notes.",
    prof_confirm_delete_subject: "Supprimer la matière « {matiere} » ? Ses notes seront déplacées dans la corbeille.",
    ...
    prof_trash_btn: "Corbeille",
    prof_trash_btn_aria: "Ouvrir la corbeille",
    prof_trash_title: "Corbeille",
    prof_trash_subtitle: "Les classes, élèves et matières supprimés restent ici tant que vous ne les effacez pas définitivement.",
    prof_trash_empty: "La corbeille est vide.",
    prof_trash_type_class: "Classe",
    prof_trash_type_student: "Élève",
    prof_trash_type_subject: "Matière",
    prof_trash_restore: "Restaurer",
    prof_trash_delete_forever: "Supprimer définitivement",
    prof_trash_confirm_delete: "Supprimer définitivement « {label} » ? Cette action est irréversible.",
    prof_trash_overwrite: "« {label} » existe déjà. Remplacer par la version restaurable ?",
    prof_trash_restored: "« {label} » a été restauré.",
    prof_trash_deleted: "« {label} » a été supprimé définitivement.",
    prof_trash_just_now: "à l'instant",
    prof_trash_ago: "il y a {n} {unit}",
    prof_trash_unit_minute_s: "minute",
    prof_trash_unit_minute_p: "minutes",
    prof_trash_unit_hour_s: "heure",
    prof_trash_unit_hour_p: "heures",
    prof_trash_unit_day_s: "jour",
    prof_trash_unit_day_p: "jours",
    prof_trash_unit_week_s: "semaine",
    prof_trash_unit_week_p: "semaines",
    prof_trash_unit_month: "mois",
    prof_trash_unit_year_s: "an",
    prof_trash_unit_year_p: "ans",
    prof_trash_purge_in: "Suppression définitive dans {n} {unit}",
    prof_trash_purge_today: "Suppression définitive aujourd'hui",
    prof_dup_title: "Doublon détecté",
    prof_dup_message: "« {label} » semble déjà exister dans cette classe.",
    prof_dup_list_title: "Certains élèves semblent déjà exister dans cette classe :",
    prof_dup_merge: "Fusionner",
    prof_dup_keep: "Conserver les deux",
    prof_dup_cancel: "Annuler",
    prof_dup_merged: "« {label} » est déjà présent : les deux entrées ont été fusionnées.",
    prof_edit_annuler: "Annuler",
    prof_edit_enregistrer: "Enregistrer",
    prof_leave_confirm_ok: "Quitter sans enregistrer",
    ...
    prof_hero_title: "Votre espace professeur",
    prof_hero_text: "Gérez vos classes, vos élèves et saisissez les notes de chaque matière. Les moyennes se calculent instantanément.",
    prof_hero_cta_classes: "Gérer mes classes",
    prof_hero_cta_students: "Voir mes élèves",
    prof_hero_cta_notes: "Saisir les notes",
    prof_activity_title: "Activité récente",
    prof_activity_empty: "Aucune activité pour le moment.",
    prof_activity_class: "Classe créée ou mise à jour",
    prof_activity_student: "Élève ajouté ou modifié",
    prof_activity_notes: "Notes enregistrées",
    prof_activity_bulletin: "Bulletin consulté",
    prof_activity_import: "Import effectué",
    prof_portal_students: "Mes élèves",
    prof_portal_ranking: "Classement",
    prof_portal_stats: "Statistiques",
    prof_portal_watch: "À surveiller",
    prof_portal_no_data: "Aucune donnée",
    prof_portal_cta_students: "Voir les élèves",
    prof_portal_cta_ranking: "Voir le classement",
    prof_portal_cta_stats: "Voir les statistiques",
    prof_portal_cta_watch: "Voir les détails",
    prof_portal_best_avg: "Meilleure moyenne",
    prof_portal_global_avg: "Moyenne générale",
    prof_portal_low_sub: "élèves avec une moyenne",
    prof_portal_none_low: "Aucun élève en difficulté.",
    prof_kpi_classes_sub: "classes suivies",
    prof_kpi_students_sub: "élèves suivis",
    prof_kpi_subjects_sub: "matières configurées",
    prof_kpi_avg_sub: "moyenne générale",
    prof_kpi_empty_sub: "en attente de données",
    prof_students_view_subtitle: "Recherchez, filtrez et consultez le profil de tous vos élèves.",
    prof_ranking_view_subtitle: "Classez vos élèves selon leur moyenne et suivez leur évolution.",
    prof_stats_view_subtitle: "Consultez les moyennes, répartitions et tendances de chaque classe.",
    sidebar_students: "Élèves",
    ...
    prof_filter_class_label: "Classe",
    prof_filter_subject_label: "Matière",
    prof_filter_rank_label: "Rang",
    label_semestre_aria: "Semestre",
    label_composition_dispo: "Composition disponible",
    ...
    fiche_moyenne_s1: "Moyenne SEM1",
    fiche_moyenne_s2: "Moyenne SEM2",
    ...
    prof_import_dropzone: "Choisir un fichier CSV, Excel ou PDF…",
    prof_import_format_label: "Formats acceptés : CSV (.csv), Excel (.xlsx) ou PDF (.pdf)",
    ...
    prof_import_done_merged: "{count} élèves importés dans la classe \"{classe}\" (dont {merged} doublons fusionnés).",
  ...
  en: {
    ...
    lang_switch_to_fr: "Switch to French",
    ...
    prof_password_show: "Show password",
    prof_password_hide: "Hide password",
    ...
    prof_nav_breadcrumb_label: "Teacher mode navigation",
    prof_logout_btn: "Sign out",
    prof_reset_data_btn: "Reset data",
    prof_confirm_reset_data: "All classes, students and grades of the teacher mode will be permanently deleted. This action cannot be undone. Continue?",
    prof_data_reset_done: "Teacher mode data has been reset!",
    ...
    prof_confirm_delete_class: "Delete the class \"{classe}\"? It will be moved to the trash.",
    prof_confirm_delete_student: "Remove this student from the class? They will be moved to the trash with their grades.",
    prof_confirm_delete_subject: "Delete the subject \"{matiere}\"? Its grades will be moved to the trash.",
    ...
    prof_trash_btn: "Trash",
    prof_trash_btn_aria: "Open the trash",
    prof_trash_title: "Trash",
    prof_trash_subtitle: "Deleted classes, students and subjects stay here until you remove them permanently.",
    prof_trash_empty: "The trash is empty.",
    prof_trash_type_class: "Class",
    prof_trash_type_student: "Student",
    prof_trash_type_subject: "Subject",
    prof_trash_restore: "Restore",
    prof_trash_delete_forever: "Delete permanently",
    prof_trash_confirm_delete: "Permanently delete \"{label}\"? This cannot be undone.",
    prof_trash_overwrite: "\"{label}\" already exists. Replace it with the restorable version?",
    prof_trash_restored: "\"{label}\" has been restored.",
    prof_trash_deleted: "\"{label}\" has been permanently deleted.",
    prof_trash_just_now: "just now",
    prof_trash_ago: "{n} {unit} ago",
    prof_trash_unit_minute_s: "minute",
    prof_trash_unit_minute_p: "minutes",
    prof_trash_unit_hour_s: "hour",
    prof_trash_unit_hour_p: "hours",
    prof_trash_unit_day_s: "day",
    prof_trash_unit_day_p: "days",
    prof_trash_unit_week_s: "week",
    prof_trash_unit_week_p: "weeks",
    prof_trash_unit_month: "month",
    prof_trash_unit_year_s: "year",
    prof_trash_unit_year_p: "years",
    prof_trash_purge_in: "Permanent deletion in {n} {unit}",
    prof_trash_purge_today: "Permanent deletion today",
    prof_dup_title: "Duplicate detected",
    prof_dup_message: "\"{label}\" seems to already exist in this class.",
    prof_dup_list_title: "Some students seem to already exist in this class:",
    prof_dup_merge: "Merge",
    prof_dup_keep: "Keep both",
    prof_dup_cancel: "Cancel",
    prof_dup_merged: "\"{label}\" is already present: the two entries have been merged.",
    prof_edit_annuler: "Cancel",
    prof_edit_enregistrer: "Save",
    prof_leave_confirm_ok: "Leave without saving",
    ...
    prof_hero_title: "Your teacher space",
    prof_hero_text: "Manage your classes and students, and enter grades for each subject. Averages are calculated instantly.",
    prof_hero_cta_classes: "Manage my classes",
    prof_hero_cta_students: "View my students",
    prof_hero_cta_notes: "Enter grades",
    prof_activity_title: "Recent activity",
    prof_activity_empty: "No activity yet.",
    prof_activity_class: "Class created or updated",
    prof_activity_student: "Student added or updated",
    prof_activity_notes: "Grades saved",
    prof_activity_bulletin: "Report card viewed",
    prof_activity_import: "Import performed",
    prof_portal_students: "My students",
    prof_portal_ranking: "Ranking",
    prof_portal_stats: "Statistics",
    prof_portal_watch: "To watch",
    prof_portal_no_data: "No data",
    prof_portal_cta_students: "View students",
    prof_portal_cta_ranking: "View ranking",
    prof_portal_cta_stats: "View statistics",
    prof_portal_cta_watch: "View details",
    prof_portal_best_avg: "Best average",
    prof_portal_global_avg: "Overall average",
    prof_portal_low_sub: "students with an average",
    prof_portal_none_low: "No struggling students.",
    prof_kpi_classes_sub: "classes tracked",
    prof_kpi_students_sub: "students tracked",
    prof_kpi_subjects_sub: "subjects configured",
    prof_kpi_avg_sub: "overall average",
    prof_kpi_empty_sub: "waiting for data",
    prof_students_view_subtitle: "Search, filter and view the profile of all your students.",
    prof_ranking_view_subtitle: "Rank your students by average and follow their progress.",
    prof_stats_view_subtitle: "Check averages, distributions and trends for each class.",
    ...
    prof_filter_class_label: "Class",
    prof_filter_subject_label: "Subject",
    prof_filter_rank_label: "Rank",
    label_semestre_aria: "Semester",
    label_composition_dispo: "Composition available",
    prof_dash_filter_high: "≥ 15",
    prof_dash_filter_mid: "10 – 15",
    prof_dash_filter_low: "< 10",
    prof_dash_filter_top5: "Top 5",
    ...
    fiche_moyenne_s1: "Average SEM1",
    fiche_moyenne_s2: "Average SEM2",
    ...
    prof_import_dropzone: "Choose a CSV, Excel or PDF file…",
    prof_import_format_label: "Accepted formats: CSV (.csv), Excel (.xlsx) or PDF (.pdf)",
    ...
    prof_import_done_merged: "{count} students imported into class \"{classe}\" ({merged} duplicates merged).",
...
(() => {
  ...
  function applyLangButton() {
    ...
    btn.setAttribute('aria-label', switchingToEnglish ? t('lang_switch_to_en') : t('lang_switch_to_fr'));
  }
