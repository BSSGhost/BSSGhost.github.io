...
<head>
    <meta charset="UTF-8">
    <title>Bulletin de Notes - LYNAQE SENEGAL</title>
    <style>
        @page {
            size: A4 portrait;
            margin: 6mm 8mm 6mm 8mm;
            @bottom-right {
                content: "LYNAQE SENEGAL — Document Officiel";
        ...
        *, *::before, *::after {
        ...
        /* Cadre principal ajusté sur 1 page */
        .document-frame {
        ...
        /* Bannière du titre */
        .doc-title-banner {
            background: linear-gradient(90deg, #0042a5 0%, #002b6d 100%);
            color: #ffffff;
            text-align: center;
            padding: 4px 6px;
            margin: 6px 0 8px 0;
        ...
        .grade-good { color: #1f7a4d; }
        .grade-average { color: #b8860b; }
        ...
        .summary-title {
            ...
            font-weight: bold;
            color: #0042a5;
            border-bottom: 1px solid #d2a84a;
            padding-bottom: 2px;
            margin-bottom: 4px;
            text-transform: uppercase;
        }
...
<div class="document-frame">
    <div class="inner-border">
        ...
        <!-- Filigrane d'arrière-plan -->
        <div class="watermark">LYNAQE SENEGAL</div>

        <!-- En-tête Institutionnel -->
        <table class="header-table">
            <tr>
                <td style="width: 38%;" class="republic-header">
                    République du Sénégal<br>
                    <span class="republic-motto">Un Peuple - Un But - Une Foi</span><br>
                    Ministère de l'Éducation Nationale<br>
                    Inspection d'Académie
                </td>
                <td style="width: 24%;" class="logo-container">
                    <img src="logo.png" class="school-logo-img" alt="Logo LYNAQE">
                </td>
                <td style="width: 38%;" class="republic-header">
                    Lycée Nation-Armée pour la Qualité et l’Équité<br>
                    <span class="republic-motto">Discipline - Excellence - Civisme</span><br>
        ...
        <div class="school-title-block">
            <h1 class="school-name">LYNAQE SENEGAL</h1>
            <div class="school-sub">BULLETIN DE NOTES OFFICIEL</div>
        </div>

        <!-- Titre du document -->
        <div class="doc-title-banner">
            <h2>BULLETIN DU SEMESTRE 1</h2>
        </div>
        ...
        <table class="info-card">
            <tr>
                ...
                <td class="value" style="font-weight: bold; font-size: 9pt; color: #0042a5;">SANKHARE Ahmadou Bamba</td>
                <td class="label">Classe :</td>
                <td class="value" style="font-weight: bold;">Seconde S1</td>
            </tr>
            <tr>
                <td class="label">Effectif :</td>
                <td class="value">32 élèves</td>
                <td class="label">Matricule :</td>
                <td class="value">2026-LYN-0428</td>
            </tr>
        </table>
        ...
        <table class="grades-table">
            <thead>
                <tr>
                    <th class="col-left" style="width: 27%;">Discipline / Matière</th>
                    <th style="width: 9%;">Devoir 1</th>
                    <th style="width: 9%;">Devoir 2</th>
                    <th style="width: 9%;">Compo.</th>
                    <th style="width: 10%;">Moy / 20</th>
                    <th style="width: 6%;">Coeff</th>
                    <th style="width: 9%;">Points</th>
                    <th class="col-left" style="width: 21%;">Appréciation</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td>15,00</td>
                    <td>17,00</td>
                    <td class="grade-highlight grade-good">16,38</td>
                    <td>5</td>
                    <td>81,90</td>
                    <td class="appreciation">Excellent travail, très rigoureux.</td>
                </tr>
                <tr>
                    ...
                    <td>16,00</td>
                    <td>15,50</td>
                    <td class="grade-highlight grade-good">15,25</td>
                    <td>4</td>
                    <td>61,00</td>
                    <td class="appreciation">Très bons résultats, esprit méthodique.</td>
                </tr>
                <tr>
                    <td class="subject-name">Sciences de la Vie (SVT)</td>
                    <td>13,50</td>
                    <td>14,50</td>
                    <td>14,00</td>
                    <td class="grade-highlight grade-good">14,00</td>
                    <td>3</td>
                    <td>42,00</td>
                    <td class="appreciation">Bon ensemble, participation active.</td>
                </tr>
                <tr>
                    ...
                    <td>13,50</td>
                    <td>13,00</td>
                    <td class="grade-highlight grade-average">12,88</td>
                    <td>3</td>
                    <td>38,64</td>
                    <td class="appreciation">Satisfaisant. Rédaction bien structurée.</td>
                </tr>
                <tr>
                    ...
                    <td>16,50</td>
                    <td>16,00</td>
                    <td class="grade-highlight grade-good">15,88</td>
                    <td>2</td>
                    <td>31,76</td>
                    <td class="appreciation">Très bon niveau d'expression écrite.</td>
                </tr>
                <tr>
                    ...
                    <td>14,00</td>
                    <td>13,50</td>
                    <td class="grade-highlight grade-average">13,50</td>
                    <td>2</td>
                    <td>27,00</td>
                    <td class="appreciation">Bon travail, connaissances solides.</td>
                </tr>
                <tr>
                    ...
                    <td>17,50</td>
                    <td>19,00</td>
                    <td class="grade-highlight grade-good">18,38</td>
                    <td>2</td>
                    <td>36,76</td>
                    <td class="appreciation">Remarquable. Maîtrise parfaite.</td>
                </tr>
                <tr>
                    <td class="subject-name">Éducation Physique (EPS)</td>
                    <td>15,00</td>
                    <td>16,00</td>
                    <td>15,00</td>
                    <td class="grade-highlight grade-good">15,25</td>
                    <td>1</td>
                    <td>15,25</td>
                    <td class="appreciation">Très bon engagement physique.</td>
                </tr>
            </tbody>
        </table>
        ...
        <div class="summary-wrapper">
            <div class="summary-box">
                <div class="summary-title">Bilan du Semestre</div>
                <table class="summary-table">
                    <tr>
                        <td style="width: 35%;"><strong>Total des coefficients :</strong> 22</td>
                        <td style="width: 35%;"><strong>Total des points obtenus :</strong> 334,31</td>
                        <td style="width: 30%; text-align: right;" rowspan="2">
                            <span class="badge-mention">MENTION : TRÈS BIEN</span>
                        </td>
                    </tr>
                    <tr>
                        <td><strong>Moyenne Générale :</strong> <span style="font-size: 10.5pt; color: #0042a5; font-weight: bold;">15,20 / 20</span></td>
                        <td><strong>Rang :</strong> <span style="font-size: 9.5pt; font-weight: bold; color: #0042a5;">2<sup>ème</sup> / 32</span></td>
                    </tr>
                </table>
            </div>
        </div>
        ...
        <table class="signatures-table">
            <tr>
                <td>
                    <div class="sig-title">L'Élève / Parent</div>
                    <div class="sig-sub">Signature & Date</div>
                </td>
                <td>
                    <div class="sig-title">Le Professeur Principal</div>
                    <div class="sig-sub">Avis & Observations</div>
                </td>
                <td>
                    <div class="sig-title">Le Proviseur / Direction</div>
        ...
        <div class="footer-note">
            Document officiel délivré par le LYNAQE SENEGAL — Lycée Nation-Armée pour la Qualité et l’Équité.
        </div>
