...
const translations = {
  fr: {
    ...
    prof_username_label: "Nom d'utilisateur",
    prof_username_placeholder: "Entrez votre nom d'utilisateur",
    prof_password_label: "Mot de passe",
    prof_password_placeholder: "Entrez le mot de passe",
    prof_login_btn: "Se connecter",
    prof_login_error: "Identifiants incorrects. Veuillez réessayer.",
    prof_login_server_error: "Serveur d'authentification indisponible. Vérifiez votre connexion internet.",
    prof_login_rate_limited: "Trop de tentatives de connexion. Veuillez réessayer dans quelques minutes.",
  ...
  en: {
    ...
    prof_username_label: "Username",
    prof_username_placeholder: "Enter your username",
    prof_password_label: "Password",
    prof_password_placeholder: "Enter the password",
    prof_login_btn: "Sign in",
    prof_login_error: "Incorrect credentials. Please try again.",
    prof_login_server_error: "Authentication server unavailable. Check your internet connection.",
    prof_login_rate_limited: "Too many sign-in attempts. Please try again in a few minutes.",
